...
/**
 * Sends an HTTP GET request to Seele
...
/**
 * Loads an account's account number and sequence from Seele
...
/**
 * Sends an HTTP POST request containing a signed transaction to Seele
